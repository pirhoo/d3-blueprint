      ...
      '/api/': [
        {
          ...
          items: [
            ...
            { text: 'D3Blueprint', link: '/api/d3blueprint.d3blueprint' },
            { text: 'Layer', link: '/api/d3blueprint.layer' },
            { text: 'ConfigManager', link: '/api/d3blueprint.configmanager' },
            { text: 'ConfigDefineOptions', link: '/api/d3blueprint.configdefineoptions' },
            { text: 'LayerOptions', link: '/api/d3blueprint.layeroptions' },
            { text: 'LayerEventMap', link: '/api/d3blueprint.layereventmap' },
          ],
        },
        {
          text: 'Types',
          items: [
            { text: 'D3Selection', link: '/api/d3blueprint.d3selection' },
            { text: 'D3Transition', link: '/api/d3blueprint.d3transition' },
            { text: 'LifecycleHandler', link: '/api/d3blueprint.lifecyclehandler' },
            { text: 'TransitionHandler', link: '/api/d3blueprint.transitionhandler' },
            { text: 'LifecycleEventName', link: '/api/d3blueprint.lifecycleeventname' },
            { text: 'LifecycleEventKey', link: '/api/d3blueprint.lifecycleeventkey' },
            { text: 'LIFECYCLE_EVENT_NAMES', link: '/api/d3blueprint.lifecycle_event_names' },
          ],
        },
        {
          text: 'Functions',
          items: [
            { text: 'isValidLifecycleEvent', link: '/api/d3blueprint.isvalidlifecycleevent' },
            { text: 'assertLifecycleEvent', link: '/api/d3blueprint.assertlifecycleevent' },
          ],
        },
      ],
