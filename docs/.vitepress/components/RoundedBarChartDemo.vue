...
class RoundedBarChart extends D3Blueprint {
  ...
  preDraw(data) {
    ...
    this.attached.bars.config({ xScale: this.xScale, yScale: this.yScale, innerHeight, fill: 'var(--vp-c-brand-1)', duration: 750, rx: 4 });
  }
}
...
<template>
  <div class="chart-demo">
    ...
    <p class="chart-demo__caption">
      Live preview: same BarsChart with <code>rx: 4</code> — one config change for rounded corners
    </p>
  </div>
</template>
